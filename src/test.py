...
if __name__ == "__main__":
    ...
    transformer = Transformer(1, srcVocabSize, tgtVocabSize, 256, 4, 32, 0.3, maxSeqLen, device)
    ...
    print(pred.size())
    # all of the code above is to see if this will even work as sort of test